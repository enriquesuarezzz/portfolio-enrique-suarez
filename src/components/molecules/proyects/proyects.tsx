  ...
  return (
    <section className="pt-10 md:pt-20">
      ...
      <div className="grid grid-cols-2 gap-20">
        <div className="relative flex h-full max-h-[500px] max-w-[500px] flex-col items-center justify-center rounded-3xl border border-gray-400 bg-gradient-to-r from-gray-800 to-gray-900 shadow-2xl">
          <Image
          ...
          <div className="px-6 py-4">
            ...
            />
            <OnestText
              text="proyecto de prueba creado con NextJS y TailwindCSS. Este proyecto es una demostración de las capacidades de estas tecnologías para construir interfaces de usuario modernas y receptivas."
              style="bold"
              fontSize="16px"
